...
const dict = {
    ko: {
        ...
        'txt_03':
        '페이크미가 생각하는 소비자는 브랜드의 환상을 소비하는 사람도 아니며, 트렌드에 맞게 변해야 하는 대상도 아닙니다. 온전하게 당신다움으로 충분히 아름답다는 것을 인정하는 사람들이길 바랍니다. 그들과 함께 "이것도 아름다울 수 있는가?"에 대한 합당한 동의를 얻어 가려합니다. 이같은 태도가 페이크미를 차별화시키며, 유지시키는 힘입니다. 가림과 변화, 시선과 응시 의미를 제품과 디자인으로 표현합니다. 페이크미의 행동이 사용자에게 스스로를 즐겁게 찾아 갈 수 있는 영감이 되길 희망합니다.',
    },
